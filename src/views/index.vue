    ...
    <div class="container">
      <div class="main">
        ...
        <div class="activeThemeContent">
          <!-- 活动背景图 -->
          <img class="activeThemeContentIcon" v-show="activeIndex == 1" src="../assets/image/bp-bg.png" alt="">
          <img class="activeThemeContentIcon" v-show="activeIndex == 2" src="../assets/image/lq-bg.png" alt="">
          <img class="activeThemeContentIcon" v-show="activeIndex == 3" src="../assets/image/bh-bg.png" alt="">
          <img class="activeThemeContentIcon" v-show="activeIndex == 4" src="../assets/image/pw-bg.png" alt="">
          <!--极限奔跑吧 -->
          <div class="activeThemeContentItem" v-show="activeIndex == 1">
            ...
            <el-row type="flex" justify="space-around" align="center" class="activeSection">
              <el-col :span="12" class="textCenter">
                <img src="../assets/image/people-pb.png" alt="" class="activeSectionIcon">
              </el-col>
              <el-col :span="12" class="sectionRight">
                ...
                <el-col :span="24">
                  <el-row type="flex" justify="space-around">
                    <el-col :span="7">
                      <div
                        :class="{ 'submitBtnGray': detail.act1_left_time == 0, 'submitBtn': detail.act1_left_time != 0 }"
                        @click="showActivity('cc', 1)">冲刺一次</div>
                    </el-col>
                    <el-col :span="7">
                      <div
                        :class="{ 'submitBtnGray': detail.act1_left_time < 3, 'submitBtn': detail.act1_left_time >= 3 }"
          ...
          <div class="activeThemeContentItem" v-show="activeIndex == 2">
            ...
            <el-row type="flex" justify="space-around" align="center" class="activeSection">
              <el-col :span="12" class="textCenter">
                <img src="../assets/image/people-jz.png" alt="" class="basketballStand">
                <img src="../assets/image/people-lq.png" alt="" class="activeSectionIcon">
              </el-col>
              <el-col :span="12" class="sectionRight">
                <el-col :span="24">
                  <el-row type="flex" justify="space-between" class="marginBottom30">
                ...
                <el-col :span="24">
                  <el-row type="flex" justify="space-around">
                    <el-col :span="7">
                      <div
                        :class="{ 'submitBtnGray': detail.act2_left_time == 0, 'submitBtn': detail.act2_left_time != 0 }"
                    ...
                    <el-col :span="7">
                      <div
                        :class="{ 'submitBtnGray': detail.act2_left_time < 3, 'submitBtn': detail.act2_left_time >= 3 }"
              ...
              <el-col :span="12" class="sectionRight">
                ...
                <el-col :span="24">
                  <el-row type="flex" justify="space-around">
                    <el-col :span="7">
                      <div
                        :class="{ 'submitBtnGray': detail.act3_left_time == 0, 'submitBtn': detail.act3_left_time != 0 }"
                    ...
                    <el-col :span="7">
                      <div
                        :class="{ 'submitBtnGray': detail.act3_left_time < 3, 'submitBtn': detail.act3_left_time >= 3 }"
            ...
            <el-row type="flex" justify="space-around" align="center" class="activeSection">
              <el-col :span="12" class="textCenter sectionRank">
                <el-row>
                  ...
                  <el-col :span="21" class="marginTop15">
                    ...
                    <img src="../assets/image/rank-4.png" v-else-if="detail.total_point >= 200" alt="">
                    <img src="../assets/image/rank-3.png" v-else-if="detail.total_point >= 150" alt="">
                    <img src="../assets/image/rank-2.png" v-else-if="detail.total_point >= 100" alt="">
              ...
              <el-col :span="12" class="sectionRank">
                ...
                <el-row class="marginTop15">
                  ...
                  <el-col :span="24">
                    <el-row type="flex" justify="space-around" class="marginTop40">
                      <el-col :span="12" class="textCenter">
                        <div
                          :class="{ 'submitBtnGray': detail.act4_left_time == 0, 'submitBtn': detail.act4_left_time != 0 }"
                      ...
                      <el-col :span="12" class="textCenter">
                        <div
                          :class="{ 'submitBtnGray': detail.act4_left_time < 5, 'submitBtn': detail.act4_left_time >= 5 }"
...
.main{
  ...
  .tableData >>>.el-table th.el-table__cell.is-leaf,
  .tableData >>>.el-table td.el-table__cell{
    border none
  }
  .tableData >>>.el-table::before{
    background-color: transparent;
  }
  .tableData >>>.el-table th.el-table__cell>.cell,
  ...
  .tableData >>>.el-table td.el-table__cell div,
